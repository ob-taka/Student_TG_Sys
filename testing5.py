...
# def deversify_schools_by_stem(tg, stem_list, non_stem_list): # nope not gonna make more work
#     stem_count = 0
#     non_stem_count = 0
#     uncertain_stem_count = 0
    
    # count stem and non-stems
    # for team in team_dict.keys():
    #     for stud in team_dict[team]:
    #         if stud.school in stem_list:
    #             stem_count += 1
    #         elif stud.school in non_stem_list:
    #             non_stem_count += 1
    #         else:
    #             uncertain_stem_count += 1

    # print(stem_count, non_stem_count, uncertain_stem_count) # there are more stem than non-stem
...
def check_results(stud_TG):
    ...
    for tg in stud_TG.keys():
        ...
        # if tg == 'G-9': # team 1 got issue idk why
            # team_school_dict = {}
            # for team in team_dict.keys():
            #     stud_school_list = []
            #     for stud in team_dict[team]:
